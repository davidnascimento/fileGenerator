...
{
    public static class GeradorLeroLero
    {
        public static string GenerateSentence()
        {
            var random = new Random();
            return openingSentence[random.Next(0, 6)]
                 + middleSentenceOne[random.Next(0, 8)]
                 + middleSentenceTwo[random.Next(0, 7)]
                 + finalSentence[random.Next(0, 21)];
        }

        static string[] openingSentence =
            {
        ...
        static string[] middleSentenceOne =
              {
        ...
        static string[] middleSentenceTwo =
              {
